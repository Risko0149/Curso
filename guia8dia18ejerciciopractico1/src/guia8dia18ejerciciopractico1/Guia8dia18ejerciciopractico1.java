...
package guia8dia18ejerciciopractico1;
...
al saldo actual.Método retirar(double): recibe una cantidad de dinero a retirar 
...
public class Guia8dia18ejerciciopractico1 {

 
    public static void main(String[] args) {
    cuentaBancariaServicio CBS = new cuentaBancariaServicio ();
    cuentaBancaria InfoB = CBS.crearCuenta();
    cuentaBancaria Infoc = CBS.ingresaDinero();
    cuentaBancaria Infod = CBS.retiraDinero();
    cuentaBancaria Infoe = CBS.extraccionRapida();
    cuentaBancaria Infof = CBS.consultarDatos(); 
    cuentaBancaria Infog = CBS.consultarSaldo(); 
